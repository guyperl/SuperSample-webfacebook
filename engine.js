// FB settings
var FB_APP_ID = '293659350686658';

// QB settings
var QB_SERVER = 'qbtest01.quickblox.com';
var QB_APP_ID = '93';
var QB_OWNER_ID = '276';
var QB_AUTH_KEY = 's3XSBCA69KWCWxw';
var QB_AUTH_SECRET = 'qnygOePysPW4COX';

// Map settings
var MAP_CENTER_LAT = 19.642587534013032;
var MAP_CENTER_LNG = -10.1953125;
var MAP_ZOOM = 2;
...
function addPlaceFirstTime(latlng) {
	...
	qbmePlace = qb.addPlace({
		lat : latlng.lat(),
		lng : latlng.lng(),
		status : 'Hi All! I have just been connected to the chat :)'
	});
...
function markerClickHandler(place, marker) {
	...
	var avatar = '';
	if (status == '') {
		status = 'No message yet.'
	}
	if (fbId == '') {
		avatar = '<img src="nophoto.png" alt="No photo" />'
	} else {
